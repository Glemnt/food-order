  ...
  <section class="food-menu">
    <div class="container">
      ...
      <?php 
          ...
          // SQL QUERY
          $sql2 = "SELECT * FROM menu WHERE ativo='Sim' AND destaque='Sim' LIMIT 6";
                  ...
                  <div class="food-menu-img">
                      <?php 
                        ...
                        else
                        {
                          ...
                          <img src="<?php echo SITEURL; ?>images/food/<?php echo $nome_imagem; ?>" alt="Chicken Hawain Pizza" class="img-responsive img-curve">
